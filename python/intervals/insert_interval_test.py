...
class TestInsertIntervalBase(ABC):
    """Abstract base test class for insert interval implementations"""

    @property
    @abstractmethod
    def SolutionClass(self):
        """Return the solution class to test"""
        pass
    ...
    def test_example_2(self):
        ...
        self.assertEqual(
            self.solution.insert(intervals.copy(), new_interval.copy()), expected
        )
